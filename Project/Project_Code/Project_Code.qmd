...
## 3.10 Clean Missing Values

In this section, we will clear out the missing values in weather data. For the visuals, we will use the **map** dataframe as the basemap.
...
## 3.11 Write Data to RDS for Shiny App

```{r}
write_rds(map, "data/rds/map.rds")
